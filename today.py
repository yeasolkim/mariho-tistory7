...
def writer():
    ...
    star1 = random.choice(
        ['오늘 ', '이번주 '])
    star2 = random.choice(
        ['날씨', '운세', '증시', '주가', '달력', '볼 수 있는 영화', '갈 수 있는 축제 ', ' 갈 만한 축제 ', '갈 만한 전시', ' 참여 펀딩', '마감', '기부', '모금', ' 별자리 운세', ' 띠 운세' ])
...
<span style="font-family: 'Noto Serif KR';">안녕하세요, 오늘은 요즘 인기있는 {star1+star2}를 모두 모아봤습니다.!<br/> 
...
<p style="text-align: center;" data-ke-size="size16"><span style="font-family: 'Noto Serif KR';"> </span><br />
<span style="font-family: 'Noto Serif KR';"> 와! {star1+star2} 대한 소식이 이렇게 많이있네요~.<br />
오늘의 소식 잘 보셨나요? 내일도 재미있고 유익한 소식 가져올테니 또 만나요, 즐거운 하루 보내세요!</span></p>
<p>&nbsp;</p>
            '''
